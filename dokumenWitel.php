...
if ($witel == '') {
    ...
    $query = query("SELECT * FROM report_obl WHERE UPPER(proses) = 'WITEL' AND UPPER(witel) = '$witel'");
}
?>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="_1">
                <a href="perangkingan.php"><button style="background-color: #6c757d;"><img src="img/list.png" alt="">Perangkingan</button></a>
                ...
                <?php foreach ($query as $row) : ?>
                    <tr>
                        ...
                        <td class="aksi" id="aksiTd">
                            ...
                            <a href="delete.php?id=<?= $row["id"]; ?>" onclick="return confirm('Yakin untuk menghapus data ini?')"><button class="delete"><img src="img/delete.png" alt=""></button></a>
                        </td>
                        <?php
                        if ($level == 'witel') {
                            echo "<script>
